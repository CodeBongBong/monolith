[![Build Status](https://dev.azure.com/admin25/cicd/_apis/build/status/cicd-CI?branchName=master)](https://dev.azure.com/admin25/cicd/_build/latest?definitionId=1&branchName=master)
